    ...
    <div id="page-wrapper">
        <div class="center-cont">
            ...
            <div class="grid_3 grid_5">
                ...
                <div class="but_list">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="#">楼栋信息管理</a></li>
                        <li class="active">增加楼栋信息 </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="tab-pane active" id="horizontal-form">
                <form class="form-horizontal" method="post" action="<%=request.getContextPath()%>/dorm/add2">
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">楼栋号</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" id="focusedinput" name="buildingId">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="disabledinput" class="col-sm-2 control-label">楼层数</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" id="disabledinput" name="floorCount">
                        </div>
                    </div>
                    <div class="form-group">
