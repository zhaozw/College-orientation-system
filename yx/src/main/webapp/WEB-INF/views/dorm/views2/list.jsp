              ...
              <table class="table table-striped  table-bordered" id="dorm-list">
                ...
                <c:forEach var="b" items="${list}">
              	...
              	>详情</a>  -->
                      ...
                      data-toggle="modal" data-target="#del"  delId="${b.buildingId }" 
                      >删除</a>
                    </td>
                  </tr>
                  </c:forEach>
...
//功能3：删除数据并使用ajax重写
		...
		function delData(buildingId){
			var url="/yx/dorm/building/" + buildingId + "/del";
			$.post(url,function(delCount){
				if(delCount!=0){
					var url="/yx/dorm/building/list";
