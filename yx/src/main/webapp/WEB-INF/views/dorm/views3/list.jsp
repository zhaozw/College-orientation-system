              ...
              <table class="table table-striped  table-bordered" id="dorm-list">
                ...
                <c:forEach var="d" items="${list}">
                  <tr>
                    ...
                    <td>1</td>
                    <td>${d.dormId }</td>
                    <td>${d.beddingCount}</td>
                    <td>${d.floor.floorId}</td>
                    <td>${d.building.buildingId}</td>
                    <td>${d.dormArea.areaName}</td>
                    <td>
              	...
              	>详情</a>  -->
                      ...
                      data-toggle="modal" data-target="#del"  delId="${d.dormId }" 
                      >删除</a>
                    </td>
                  </tr>
                  </c:forEach>
...
//功能3：删除数据并使用ajax重写
		...
		function delData(dormId){
			var url="/yx/dorm/dormitory/" + dormId + "/del";
			$.post(url,function(delCount){
				if(delCount!=0){
					var url="/yx/dorm/dormitory/list";
