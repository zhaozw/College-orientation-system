              ...
              <table class="table table-striped  table-bordered" id="dorm-list">
                ...
                <c:forEach var="f" items="${list}">
                  <tr>
                    ...
                    <td>${f.floorId }</td>
                    <td>${f.dormCount}</td>
                     <td>${f.building.buildingId}</td>
                    <td>${f.dormArea.areaName}</td>
                    <td>
              	...
              	>详情</a>  -->
                      ...
                      data-toggle="modal" data-target="#del"  delId="${f.floorId }" 
                      >删除</a>
                    </td>
                  </tr>
                  </c:forEach>
...
//功能3：删除数据并使用ajax重写
		...
		function delData(floorId){
			var url="/yx/dorm/floor/" + floorId + "/del";
			$.post(url,function(delCount){
				if(delCount!=0){
					var url="/yx/dorm/floor/list";
