              ...
              <table class="table table-striped  table-bordered" id="dorm-list">
                ...
                <c:forEach var="ds" items="${list}">
                  <tr>
                    ...
                    <td>${ds.dormitory.dormId}</td>
                    <td>${ds.floor.floorId}</td>
                    <td>${ds.building.buildingId}</td>
                    <td>${ds.dormArea.areaName}</td>
                    <td class="status">
              	...
              	>详情</a>  -->
                      ...
                      data-toggle="modal" data-target="#del"  delId="${ds.dormStudentId }" 
                      >删除</a>
                    </td>
                  </tr>
                  </c:forEach>
...
//功能3：删除数据并使用ajax重写
		...
		function delData(dormStudentId){
			var url="/yx/dorm/dormStu/" + dormStudentId + "/del";
			$.post(url,function(delCount){
				if(delCount!=0){
					var url="/yx/dorm/dormStu/list";
