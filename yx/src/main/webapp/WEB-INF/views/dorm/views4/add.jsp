    ...
    <div id="page-wrapper">
        <div class="center-cont">
            ...
            <div class="tab-pane active" id="horizontal-form">
                <form class="form-horizontal"  method="post" action="<%=request.getContextPath()%>/dorm/add5">
                    
                     <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">学生姓名</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" id="focusedinput" name="student.studentName">
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">学号</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" id="focusedinput" name="student.stuId">
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">宿舍号</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" id="focusedinput" name="dormitory.dormId">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">楼层号</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" id="focusedinput" name="floor.floorId">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="disabledinput" class="col-sm-2 control-label">楼栋号</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" id="disabledinput" name="building.buildingId">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="disabledinput" class="col-sm-2 control-label">宿舍区</label>
                       <div class="col-sm-8">
                             <select id="selector1" class="form-control1" name="dormArea.areaName">
                                <option></option>
                                <option >华山区</option> <!-- value="112"-->
                                <option >五山区</option>
                                <option >启林区</option>
                                <option >燕山区</option>
                                <option >东区</option>
                        ...
                        <div class="form-group">
	                        <label for="radio" class="col-sm-2 control-label">新生物品</label>
	                        <div class="col-sm-8">
	                            <div class="radio-inline"><label><input type="radio" name="${haveProduct} " value="1">有</label></div>
	                            <div class="radio-inline"><label><input type="radio" name="${haveProduct} " value="0">无</label></div>
	                        </div>
                    	</div>
                    </div>
                     <div class="row">
