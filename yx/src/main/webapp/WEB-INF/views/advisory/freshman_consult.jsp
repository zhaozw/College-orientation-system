...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
    ...
    <link href="/yx/assets/css/style.css" rel='stylesheet' type='text/css' />
    <link rel="stylesheet" type="text/css" href="/yx/assets/css/own.css">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa"></i>咨询者咨询模块<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="../view_consult/search_consult.html">咨询者咨询</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
    ...
    <div id="page-wrapper">
        ...
        <div class="grid_3 grid_5">
            ...
            <div class="but_list">
                ...
                <!--</ol>-->
                <ol class="breadcrumb">
                <li><a href="#">咨询者咨询模块</a></li>
                <li class="active">搜索咨询记录    咨询    我的咨询</li>
                </ol>
            </div>
        </div>
        
        <!-- 222 -->
            <div class="search zx-fn">
                <div class="input-append input-prepend">
                    <span class="add-on"><i class="icon-search"></i></span>
                    <button type="submit" class="btn btn-primary"><i class="icon-search icon-white">请选择：</i></button>
                </div>
            </div>
            <div class="search zx-fn">
                <div class="input-append input-prepend">
                    <span class="add-on"><i class="icon-search"></i></span>
                    <input type="text" name="s" id="search" placeholder="请输入关键字" value="" class="placeholder">
                    <button type="submit" class="btn btn-primary"><i class="icon-search icon-white">搜索</i></button>
                </div>
            </div>
             ...
             <div class="search zx-fn">
                <div class="input-append input-prepend">
                    <span class="add-on"><i class="icon-search"></i></span>
                    <button type="submit" class="btn btn-primary"><i class="icon-search icon-white" href="#" data-toggle="modal" data-target="#myModal2">咨询</i></button>
                </div>
            </div>

             <div class="search2 zx-fn">
                <div class="input-append input-prepend">
                    <span class="add-on"><i class="icon-search"></i></span>
                    <button type="submit" class="btn btn-primary"><i class="icon-search icon-white" >我的咨询</i></button>
                </div>
            </div>
            ...
            <div class="panel-body no-padding" style="display: block;">
              <table class="table table-striped  table-bordered">
                <thead>
                  <tr class="success">
                    <th>
                      <input id="all" type="checkbox" class="checkbox"/>
                    </th>
                    <th>咨询编号</th>
                    <th>主题分类</th>
                    <th>内容简介</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>1</td>
                    <td>专业课程</td>
                    <td><textarea>这是一个关于专业课程的咨询</textarea></td>
                    <td>李四</td>
                    <td>2016-08-15 10:30:29</td>
                    <td>
                      <a type="button" class="btn-info btn-sm btn" href="#" data-toggle="modal" data-target="#myModal1">详情</a>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>2</td>
                    <td>就业</td>
                    <td><textarea>这是一个关于就业的咨询</textarea></td>
                    <td>王五</td>
                    <td>2016-08-17 20:11:29</td>
                    <td>
                      <a type="button" class="btn-info btn-sm btn" href="#" data-toggle="modal" data-target="#myModal1">详情</a>
                    </td>
                  </tr>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
								 ...
								 <tr>
                                    <th class="th1">收到回复</th>
                                    <td colspan="3">不大清楚。</td>
                                </tr>
                                <tr>
                                    <th>回复内容</th>
                                    <td colspan="3">
