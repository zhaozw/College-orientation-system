						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input disabled="" type="text" class="form-control1" id="name"
											placeholder="departmentName" value="软件学院">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input disabled="" type="text" class="form-control1"
											id="president" placeholder="president" value="刘财兴">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input disabled="" type="text" class="form-control1"
											id="vicePresident" placeholder="vicePresident" value="林丕源">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input disabled="" type="text" class="form-control1"
											id="address" placeholder="address" value="广东省广州市天河区五山路11号">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input disabled="" type="text" class="form-control1"
											id="phone" placeholder="phone" value="0750-36236680">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input disabled="" type="text" class="form-control1"
											id="zipCode" placeholder="zipCode" value="529100">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea name="txtarea1" id="description" cols="50" rows="80"
											class="form-control1" readonly="readonly">软件学院是一个很好的学院</textarea>
									</div>
								</div>
							</form>
						</div>
