            ...
            <div class="tab-pane active" id="horizontal-form">
                <form class="form-horizontal"  method="post" >
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" id="stuName" name="student.studentName">
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">学号</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" id="stuId" name="student.stuId">
                        </div>
                    </div>
                     <div class="form-group">
...
<script type="text/javascript">
	...
	$("#submit").on('click',function (e){
		...
		var dormId =$("#dorm").val();
		add(stuName,stuId,areaId,areaName,buildingId,floorId,dormId);
	});
	
	function add(stuName,stuId,areaId,areaName,buildingId,floorId,dormId){
		var url="/yx/dormModule/add2";
		$.post(url,{stuName:stuName,stuId:stuId,areaId:areaId,areaName:areaName,buildingId:buildingId,floorId:floorId,dormId:dormId},function(addCount){
			if(addCount!=0){
