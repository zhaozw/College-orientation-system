...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
          ...
          fields: {
			...
			e.preventDefault();
		     ...
		     var tbody=$("#page-wrapper > div > div.col_1 > div.col-md-12 > div.panel.panel-warning > div.panel-body.no-padding > table > tbody");
		      	 ...
		      	 var tr=$("<tr></tr>");
		         var registerStatus=(student.studentStatus.register ==0)?"未完成报到及注册":"已完成报到及注册";
		             ...
		             tr.append($("<td></td>").html('<a type="button" class="btn-info btn-sm btn">确认报到&注册</a>'));
		       	     tbody.append(tr);
  ...
  function loadRegisterStateById(){
		
	  }
	  
	  function loadRegisterStateByStuIdAndName(){
    ...
    <div id="page-wrapper" style="background-color:#f2f4f8">
      <div class="graphs">
        ...
        <div class="col_1"  style="margin-top:1em">
          ...
          <div class="col-md-12">
            <div class="r3_counter_box" style="padding: 30px 30px 2px 30px;">
