        ...
        message: 'This value is not valid',
          ...
          fields: {
			...
			e.preventDefault();
		     ...
		     var tr=$("<tr></tr>");
		     var fileSubmitStatus=(student.studentStatus.fileSubmit ==0)?"未提交":"已提交";
		         ...
		         tr.append($("<td></td>").html('<a type="button" class="btn-info btn-sm btn">确认档案提交</a>'));
...
<body>
 ...
 <ul class="user-menu">
    ...
    <div class="navbar-default sidebar" role="navigation"  style="min-height:37em">
