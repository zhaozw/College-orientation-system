                ...
                <div class="col-md-5">
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control1 required" placeholder="例:系统管理员" id="searchRoleName" name="searchRoleName" data-bv-notempty data-bv-notempty-message="角色名称不能为空！" /></div>
                  </div>
                </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group" style="margin-top:30px;font-size:16px;">
                          ...
                          <input type="text"  class="form-control1"  id="roleName" name="roleName" placeholder="例:系统管理员">
                          </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                          		...
                          		<input type="text" class="form-control1" id="modifiedRoleId" name="modifiedRoleId" placeholder="例:XP-1">
                          </div>
                        </div>
                        <div class="form-group" style="margin-top:30px;font-size:16px;">
                          ...
                          <input type="text"  class="form-control1"  id="modifiedRoleName" name="modifiedRoleName" placeholder="例:系统管理员">
                          </div>
                        </div>
                        <div class="form-group">
