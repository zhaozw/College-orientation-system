		...
		<div class="navbar-default sidebar" style="min-height: 61em;"
			...
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"> <span class="glyphicon glyphicon-th"></span>
							现场迎新管理 <span class="fa arrow" />
					</a>
						<ul class="nav nav-second-level">
							<li><a href="checkIn.html">登记报到单打印状态</a></li>
							<li><a href="militarySuppliesManagement.html">军训用品发送管理</a></li>
							<li><a href="studySuppliesManagement.html">学习用品发放管理</a></li>
							<li><a href="cardManagement.html">一卡通发放管理</a></li>
							<li><a href="medicareManagment.html">医保办理管理</a></li>
							<li><a href="sitePayment.html">现场缴费管理</a></li>
							<li><a href="departmentReport.html">院系报到管理</a></li>
							<li><a href="fileSubmission.html">档案提交管理</a></li>
							...
							<fieldset>
								<div class="form-group">
									<div class="row">
										...
										<div class="col-md-4">
											<div class="input-group">
												<span class="input-group-addon" id="basic-addon1">输入学生号&nbsp;&nbsp;</span>
												<input type="text" class="form-control1"
													placeholder="例:201135260327"
										...
										<div class="col-md-4">
											<div class="input-group">
												<span class="input-group-addon" id="basic-addon2">输入&nbsp;姓名</span>
												<input type="text" class="form-control1" placeholder="例:张继科"
													aria-describedby="basic-addon1"> <span
													class="input-group-addon btn" id="basic-addon2"> <span
									...
									<div class="form-group row">
										...
										<div class="col-md-5">
											<div class="input-group">
												<span class="input-group-addon" id="basic-addon1">输入身份证号</span>
												<input type="text" class="form-control1"
													placeholder="例:440678199305268764"
													aria-describedby="basic-addon1"> <span
													class="input-group-addon btn" id="basic-addon3"> <span
													class="glyphicon glyphicon-search"></span> &nbsp;查询
												</span>
											</div>
										</div>
											...
											<table class="table table-striped  table-bordered">
												...
												<tbody>
													<tr>
														...
														<td>19</td>
														<td>1302</td>
														<td><a type="button" class="btn-info btn-sm btn">报到</a>
														</td>
														<td><a type="button" class="btn-info btn-sm btn">打印</a>
														</td>
													</tr>
													<tr>
														<td>2</td>
