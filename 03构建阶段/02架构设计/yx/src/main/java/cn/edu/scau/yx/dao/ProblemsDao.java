...
public interface ProblemsDao {
	 ...
	 * @return
	 */
	Problems findByAudit(String audit);
	 ...
	 * @return
	 */
	Problems findByAuthority(String authority);
	 ...
	 * @return
	 */
	List<Problems> findByAuditWithKeyWord(String audit,String keyWord);
	 ...
	 * @return
	 */
	List<Problems> findByAuthorityWithKeyWord(String authority,String keyWord);
	 ...
	 * @return
	 */
	List<Problems> findWithAllKey(String audit,String authority,String keyWord);
