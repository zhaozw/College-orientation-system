								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="president"
											placeholder="president" value="刘财兴">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="vicePresident"
											placeholder="vicePresident" value="林丕源">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="address"
											placeholder="address" value="广东省广州市天河区五山路11号">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="phone"
											placeholder="phone" value="0750-36236680">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="zipCode"
											placeholder="zipCode" value="529100">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="networkAddress"
											placeholder="networkAddress" value="scausf@edu.cn">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea name="txtarea1" id="description" cols="50" rows="80"
											class="form-control1">软件学院是一个很好的学院</textarea>
									</div>
								</div>
							</form>
						</div>
								...
								<div class="row">
									<div class="col-sm-8 col-sm-offset-2">
										<button class="btn-success btn">
											<a href="findDepartment.html">保存修改 
										</button>
